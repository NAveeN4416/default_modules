			...
			<div class="row">
				...
				<div class="col-md-10">
					<?PHP
						...
						?>
        			 <form action="<?=base_url($__controller.'/updateOurMissionDetails');?>" class="form-horizontal" method="post" enctype="multipart/form-data"> 
