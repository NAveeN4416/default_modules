			...
			<div class="row">
				...
				<div class="col-md-10">
					<?PHP
						...
						?>
        			 <form action="<?=base_url($__controller.'/updateOurMessageDetails');?>" class="form-horizontal" method="post" enctype="multipart/form-data"> 
