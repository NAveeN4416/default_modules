...
<div id="content-main">
		<h3><?=getSystemString(380)?></h3>
			<div class="row">
				
				<?PHP
					$this->load->view('acp_includes/response_messages');
				?>
				<form action="<?=base_url($__controller.'/updatePrivacyPolicy');?>" class="form-horizontal" method="post">
					<div class="col-md-10">
