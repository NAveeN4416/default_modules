...
var ChartsAmcharts = function() {
    ...
    function generateChartData(dataValues) {
        ...
        for (var i = 0; i < dataValues.length; i++) {
            chartData.push({
                Name: dataValues[i].ColumnName,
                visits: dataValues[i].Value,
    ...
    var initChartSample5 = function() {
        var chart = AmCharts.makeChart("chart_5", {
            ...
            "export": {
                "enabled": true,
                "libs": {
                    "path": "/design/css/plugins/amcharts/amcharts/plugins/export/libs/"
                }
            },
            //"exportConfig": {
            //    "menuTop": "20px",
            //    "menuRight": "20px",
            //    "menuItems": [{
            //        "icon": "css/plugins/amcharts/amcharts/images/export.png",
            //        "format": 'png'
            //    }]
            //}
        }, 0);

        $('.chart_5_chart_input').off().on('input change', function() {
    ...
    var initChartSample6 = function () {
        var chart = AmCharts.makeChart("chart_6", {
            ...
            "outlineThickness": 2,
            "labelPosition": "right",
            "balloonText": "[[Name]]: [[visits]]n[[description]]",
            "rotate":false,
            "export": {
                "enabled": true,
                "libs": {
    ...
    var initChartSample7 = function() {
        ...
        $('.chart_7_chart_input').off().on('input change', function() {
            var property = $(this).data('property');
            var target = chart;
